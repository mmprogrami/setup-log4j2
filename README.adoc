...
A variant of the same dependency (with classifier 'test')  also includes a log4j2 configuration file.  This can be used as a 'test' dependency, which suffices for most cases.
